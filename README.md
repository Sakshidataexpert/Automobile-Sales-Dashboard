...
• Multiple countries (Australia, Austria, Belgium, Canada, Denmark, Finland, France, Germany, Ireland, etc.)
• Cities within each country
• Product categories (Classic Cars, Vintage Cars, Motorcycles, Trucks & Buses, Planes, Ships, Trains)
...
Total Tax: ₹14,288.74
Provides a quick financial performance overview.

🔹 Sales Based on Year (Line Chart)
Displays year-over-year revenue trends, highlighting peak sales periods and declines.

🔹 Sales Based on Country (Pie Chart)
Shows contribution of each country to total sales revenue.

🔹 City vs Sales Count (Bar Chart)
Ranks cities based on total sales volume to identify top-performing locations.

🔹 Profit/Tax Based on Product (Horizontal Bar Chart)
Compares product-wise profit and tax impact to evaluate product efficiency.

🔹 Interactive Filters (Slicers Panel)
